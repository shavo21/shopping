										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-info" href="{{ action('AdminController@getEditUser',  $user->id) }}">
														<i class="ace-icon fa fa-pencil bigger-120" data-toggle="tooltip" data-placement="left" title="{{trans('tooltip.edit_user')}}"></i>
													</a>

													<a class="btn btn-xs btn-danger delete" data-toggle="modal" data-target="#myModalDelete" href='#' data-href="{{ action('AdminController@getRemoveUser',  $user->id) }}">
														<i class="ace-icon fa fa-trash-o bigger-120" data-toggle="tooltip" data-placement="left" title="{{trans('tooltip.delete_user')}}"></i>
													</a>
												</div>
											</td>
										</tr>
